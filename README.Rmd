...
in 3D geometries because they are inherently, *topologically*, one-dimensional. Gibble provides a simple bridge between
path and primitive types, which generalize to any topological dimension. Gibble considers a point to 
